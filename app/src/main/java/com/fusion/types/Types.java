...
public class Types {
    ...
    public final int MAXMEASUREMENTS = 340;				// maximum number of measurements used for calibration
    ...
    public final int  MESHDELTACOUNTS = 50;				// magnetic buffer mesh spacing in counts (here 5uT)
